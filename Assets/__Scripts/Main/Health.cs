...
#endif
    public void Kill(bool ignoreInvulnirability = false)
    {
        TakeDamage(maxHealth, ignoreInvulnirability);
    }

    public void TakeDamage(int amount, bool ignoreInvulnirability = false)
    {
